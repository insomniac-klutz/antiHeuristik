...
Every unit of prep is a **Build** — a system you design, prototype, and then deepen through **Layers**.
...
3. **walls.md is the most important file.** It's the raw record of what you didn't know. This becomes your study list AND your interview depth.
...
6. **No completion theater.** A Build is done when you can whiteboard it cold and explain every decision. Not when you've filled in all the files.
...
Ask: "If someone asked me to whiteboard this in an interview tomorrow, which one would make me sweat?" Do that one.
...
- **Record yourself on walks.** Story reps and ambiguity exercises happen in dead time. Speak out loud, listen back, cut the fluff.
- **3-minute cap.** Every story answer should be under 3 minutes on first pass. If it's longer, you're rambling.
- **Explain like you're whiteboarding.** Not reading notes. Drawing, pointing, walking through flow.
- **IC6+ framing.** You're not answering "what is RAG?" — you're answering "here's why I chose this architecture, here's what I'd change at 10x scale, here's what I said no to." Lead with decisions, not definitions.

## The Anti-List (Don't Waste Time Here)

| Topic | Why it's cut |
|-------|-------------|
| DSA / leetcode-style | If they need this for Applied AI, wrong company. Basic Python data structures are enough. |
| OOP theory | You write OOP daily. No one's asking you to explain polymorphism in 2026. |
...
| Reinforcement Learning | Unless the JD says RL, skip entirely. |
| Recommendation Systems | Only if JD-specific. |

## Interview Red/Green Flags

**Green (your kind of company):**
- "Design a RAG system for [domain]"
- "How would you evaluate an LLM pipeline?"
- "Tell me about a production AI system you shipped"
- "How would you reduce latency/cost for this AI feature?"
- System design rounds focused on AI architecture

**Red (not your fight):**
- Leetcode hard as primary filter
- "Derive backpropagation"
- "Explain the kernel trick"
- 5-round process with no AI-specific round
- "We use traditional ML for everything"
